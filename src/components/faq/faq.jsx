...
const Faq = () => {
  const [activeIndex, setActiveIndex] = useState(Array(18).fill(false)); // Initialize active state for each panel

  const togglePanel = (index) => {
    const newActiveIndex = [...activeIndex]; // Create a copy of the activeIndex array
    newActiveIndex[index] = !newActiveIndex[index]; // Toggle the active state for the clicked panel
    setActiveIndex(newActiveIndex); // Update the state
  };
  ...
  return (
    <div id="faq">
      ...
      <div className="genFaq question-section" id="genFaq">
        ...
        <div className="dropdown-join-container">
          <div className="dropdown-ctr">
            ...
            <button className={`accordion ${activeIndex[0] ? 'active' : ''}`} onClick={() => togglePanel(0)}>I’d like to know about upcoming TEDxUofW events?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[0] ? 'rotate' : ''}`} /></div></button>
            <div className={`panel ${activeIndex[0] ? '' : 'minimize'}`} style={{ display: activeIndex[0] ? 'block' : 'none' }}>
            ...
            <button className={`accordion ${activeIndex[1] ? 'active' : ''}`} onClick={() => togglePanel(1)}>How can I volunteer?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[1] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[2] ? 'active' : ''}`} onClick={() => togglePanel(2)}>Are TEDxUofW events open to the public?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[2] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[3] ? 'active' : ''}`} onClick={() => togglePanel(3)}>Can I watch past TEDxUofW talks online?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[3] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[4] ? 'active' : ''}`} onClick={() => togglePanel(4)}>Still have questions?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[4] ? 'rotate' : ''}`} /></div></button>
      ...
      <div className="speakerFaq question-section" id="speakerFaq">
        ...
        <div className="dropdown-join-container">
          <div className="dropdown-ctr">
            <button className={`accordion ${activeIndex[5] ? 'active' : ''}`} onClick={() => togglePanel(5)}>How do I become a speaker?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[5] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[6] ? 'active' : ''}`} onClick={() => togglePanel(6)}>What does being a speaker entail?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[6] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[7] ? 'active' : ''}`} onClick={() => togglePanel(7)}>What are talk development sessions?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[7] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[8] ? 'active' : ''}`} onClick={() => togglePanel(8)}>How many speakers will be at the conference?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[8] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[9] ? 'active' : ''}`} onClick={() => togglePanel(9)}>Does my talk need to be memorized?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[9] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[10] ? 'active' : ''}`} onClick={() => togglePanel(10)}>What does the theme of the event have to do with me?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[10] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[11] ? 'active' : ''}`} onClick={() => togglePanel(11)}>How strict are speaker deadlines?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[11] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[12] ? 'active' : ''}`} onClick={() => togglePanel(12)}>What if I need special accommodations?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[12] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[13] ? 'active' : ''}`} onClick={() => togglePanel(13)}>Are travel costs and lodging covered by TEDxUofW?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[13] ? 'rotate' : ''}`} /></div></button>
      ...
      <div className="sponsorFaq question-section" id="sponsorFaq">
        ...
        <div className="dropdown-join-container">
          <div className="dropdown-ctr">
            <button className={`accordion ${activeIndex[14] ? 'active' : ''}`} onClick={() => togglePanel(14)}>I’d like to provide support or sponsor the event.<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[14] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[15] ? 'active' : ''}`} onClick={() => togglePanel(15)}>My company wants to provide a food/item/service to the attendees of at a TEDxUofW conference.<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[15] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[16] ? 'active' : ''}`} onClick={() => togglePanel(16)}>What are the sponsorship benefits and tiers?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[16] ? 'rotate' : ''}`} /></div></button>
            ...
            <button className={`accordion ${activeIndex[17] ? 'active' : ''}`} onClick={() => togglePanel(17)}>What payment methods are accepted?<div className="arrowContainer"><img src={downArrow} alt="down arrow img" className={`arrow ${activeIndex[17] ? 'rotate' : ''}`} /></div></button>
